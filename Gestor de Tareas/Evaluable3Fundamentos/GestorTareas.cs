...
public class GestorTareas
{
    ...
    public void Exportar()
    {
        ...
        Console.WriteLine("Tareas exportadas a 'tareas.txt'. Contenido:");
        Console.WriteLine("---------------------------------------------");
        foreach (var linea in File.ReadAllLines("tareas.txt"))
        {
            Console.WriteLine(linea);
        }

        // Opcional: abre el archivo en el Bloc de Notas
        try
        {
            System.Diagnostics.Process.Start("notepad.exe", "tareas.txt");
        }
        catch
        {
            Console.WriteLine("No se pudo abrir el archivo automáticamente.");
        }
    }
    ...
    public void Importar()
    {
        ...
        Console.WriteLine("Tareas importadas correctamente. Contenido:");
        Console.WriteLine("---------------------------------------------");
        foreach (var linea in lineas)
        {
            Console.WriteLine(linea);
